...
#define PIDDB_LOCK_PATTERN "\x48\x8D\x0D\x00\x00\x00\x00\xB2\x01\x66\xFF\x88\xE4\x01\x00\x00\x90\xE8\x00\x00\x00\x00\x4C\x8B\x8C\x24\x88\x00\x00\x00"//在PpCheckInDriverDatabase里
...
#define MMU_PATTERN "\x4C\x8B\x15\x00\x00\x00\x00\x4C\x8B\xC9"//MmLocateUnloadedDriver里
#define MMU_MASK "xxx????xxx"


#define MML_PATTERN "\x8B\x05\x00\x00\x00\x00\x83\xF8\x32"//在MiRememberUnloadedDriver里
#define MML_MASK "xx????xxx"


#define CI_DLL_KERNEL_HASH_BUCKET_PATTERN "\x48\x8B\x1D\x00\x00\x00\x00\xEB\x00\xF7\x43\x40\x00\x20\x00\x00"//在I_SetSecurityState里
